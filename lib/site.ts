...
export const services: Service[] = [
  {
    ...
    objective:
      'Transform fragmented AI usage into a structured, repeatable system across the organization.',
    scope: [
      'Audit of current AI usage across team members and functions',
      'Identification of gaps, duplication, and high-leverage opportunities',
      'Setup of a centralized AI workspace appropriate to your existing stack',
      'Creation of prompt libraries and workflow templates by function',
      'Definition of tool usage standards (ChatGPT vs. Claude vs. specialized)',
